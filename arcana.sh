...
try:
	MongoClient("mongodb+srv://locus_user:mFWQVTwIozdHo504@locus.b3sgeev.mongodb.net/?retryWrites=true&w=majority").admin.command("ping")
except Exception as e:
	print("                Error ┖╴\x1b[31m"+str(e)+"\nProgram aborted. Contact developer at github repository or admin.")
	quit()
print("        Server Module ┖╴\x1b[32mSUCCESS\x1b[39;49m")
print("━━━━━━━━━━━━━━━━━━━━━━┳━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n[ 3: LOADING  LOCUS ] ┃ Run \x1b[0;1m/help\x1b[0m Or Read \x1b[0;1mREADME.md\x1b[0m For Info.")
cluster,uri="",""
cluster=MongoClient("mongodb+srv://locus_user:mFWQVTwIozdHo504@atlascluster.b3sgeev.mongodb.net/?retryWrites=true&w=majority")
db,id_=cluster["locus"]["messages"],""
