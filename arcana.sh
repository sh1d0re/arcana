...
try:
	MongoClient("mongodb+srv://arcana_user:mFWQVTwIozdHo504@arcana.b3sgeev.mongodb.net/?retryWrites=true&w=majority").admin.command("ping")
except Exception as e:
	print("                Error ┖╴\x1b[31m"+str(e)+"\nProgram aborted. Contact developer at github repository or admin.")
	quit()
...
cluster,uri="",""
cluster=MongoClient("mongodb+srv://arcana_user:mFWQVTwIozdHo504@atlascluster.b3sgeev.mongodb.net/?retryWrites=true&w=majority")
